...
class AnnotatedFile:
    ...
    def __init__(self, annot_data: Dict, all_labels: List[str], sample_duration: float):
...
class Domain_set:
    ...
    def __init__(self, label_mapping, data_, frame_info, all_labels: List[str], sample_duration: float):
        ...
        for i, domain_name in enumerate(self.domain_names):
            domain_annotated_files = [AnnotatedFile(fin, all_labels, sample_duration) for fin in file_set
